...
$content = Get-Content "GGXrdStopResettingINITwiceAYear.rc"
$newline = "`
"
$tab = "	";

$TRUE_VERSION = parse_version("PatcherVersion.h")
...
if ($need_write) {
	Set-Content -Value ($content_lines -join $newline) "GGXrdStopResettingINITwiceAYear.rc" -Encoding Unicode
}
